...
namespace GoogleSheetsToUnity
{
    ...
    public class GSTU_Search
    {
        ...
        public readonly string endCell = "AE100";
   ...
   /*     public GstuSpreadSheet(GSTU_SpreadsheetResponce data)
        ...
        {
            if (data.valueRange.values.Count == 0)
            {
                Debug.LogWarning("GSTU_SpreadsheetResponce: Value Range = 0");
                return;
            }
