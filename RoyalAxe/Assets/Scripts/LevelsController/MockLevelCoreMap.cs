...
namespace RoyalAxe.CoreLevel
{
    public class MockLevelCoreMap : IRoyalAxeCoreMap, IEnemyWaveGenerator
    {
       ...
       private readonly IGroup<UnitsEntity> _allMobs;
        ...
        public MockLevelCoreMap(UnitsContext unitsContext, IUnitsBuilderFacade unitsBuilder, IMobPositionGenerator mobPositionGenerator, ILevelWaveProvider levelWaveProvider)
        {
